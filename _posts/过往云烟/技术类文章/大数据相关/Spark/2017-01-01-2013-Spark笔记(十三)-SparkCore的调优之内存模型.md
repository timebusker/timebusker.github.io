...
![HashShuffleManager](img/older/spark/13/1.png)
...
![HashShuffleManager](img/older/spark/13/2.png)
...
![HashShuffleManager](img/older/spark/13/3.png)

##### 统一内存管理
Spark 1.6 之后引入的统一内存管理机制，与静态内存管理的区别在于存储内存和执行内存共享同一块空间，
可以动态占用对方的空闲区域，如图所示：

![HashShuffleManager](img/older/spark/13/4.png)
![HashShuffleManager](img/older/spark/13/5.png)
...
![HashShuffleManager](img/older/spark/13/6.png)
...
![HashShuffleManager](img/older/spark/13/7.png)
...
![HashShuffleManager](img/older/spark/13/8.png)
