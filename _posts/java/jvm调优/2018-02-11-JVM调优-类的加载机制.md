...
![image](https://raw.githubusercontent.com/timebusker/timebusker.github.io/master/img/java-coding/jvm/1.png?raw=true) 
...
类加载的过程包括了`加载、验证、准备、解析、初始化`五个阶段。在这五个阶段中，加载、验证、准备和初始化这四个阶段发生的顺序是确定的，
...
`类加载器的层次关系`   
![image](https://raw.githubusercontent.com/timebusker/timebusker.github.io/master/img/java-coding/jvm/3.jpg?raw=true) 

`父类加载器并不是通过继承关系来实现的，而是**采用组合实现**的。`
