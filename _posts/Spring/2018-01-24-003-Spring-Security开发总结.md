...
### Spring Security 校验流程图
![Spring Security 登录流程.jpg](https://github.com/timebusker/timebusker.github.io/blob/master/img/spring-security/7.jpg?raw=true)
#### AbstractAuthenticationProcessingFilter 抽象类
...
![Spring Security 登录流程.jpg](https://github.com/timebusker/timebusker.github.io/blob/master/img/spring-security/7.png?raw=true)
